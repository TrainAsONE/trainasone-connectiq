  ...
  function handleErrorResponseCode(action, responseCode) {
    switch(responseCode) {
      ...
      case Communications.BLE_UNKNOWN_SEND_ERROR:
        Message.showErrorMessage(WatchUi.loadResource(Rez.Strings.errorPhoneConnection) + " " + responseCode + " " + action);
        break;
      ...
      case 401: // Unauthorized
        WatchUi.switchToView(new GrantView(true, false), new GrantDelegate(), WatchUi.SLIDE_IMMEDIATE);
        break;
      case 404: // not found
      ...
      case 503: // service unavailable
        ...
        break;
      default:
        Message.showErrorMessage(WatchUi.loadResource(Rez.Strings.serverError) + " " + responseCode + " " + action);
        break;
    }
  }
